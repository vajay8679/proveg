...
$query ="select title FROM gallery_menu where id='$stv'";
...
$sql = "insert into gallery_image values('','$oid','$photo','$desc','$name')";
...

{
	...
	$dlt =mysqli_query($con,"select image FROM gallery_image where id='$filter'");
	...
	$del=mysqli_query($con,"delete from gallery_image where id='$filter'");
...
?>
  ...
  $sql=mysqli_query($con,"select * from gallery_image where oid='$stv'");
