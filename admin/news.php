...
?>
  ...
  <tr>
    ...
    <td style="vertical-align:middle;">Add News:</td>

    <td><textarea style="width:233px;" required="required" name="news"></textarea></td>
  ...
  <tr style="border-bottom:#999 1px solid;">
    ...
    <td><a href="news.php?filter=<?php echo $id; ?>" style="padding:0;"><h4>Delete</h4></a></td>
