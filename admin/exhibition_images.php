...
$query ="select title FROM exhibition where id='$stv'";
...
$sql = "insert into exhibition_image values('','$oid','$photo','$desc','$name')";
...

{
	...
	$dlt =mysqli_query($con,"select image FROM exhibition_image where id='$filter'");
	...
	$del=mysqli_query($con,"delete from exhibition_image where id='$filter'");
...
?>
  ...
  $sql=mysqli_query($con,"select * from exhibition_image where oid='$stv'");
  ...
  <tr style="border-bottom:#999 1px solid;">
    ...
    <td><a href="exhibition_images.php?filter=<?php echo $id ?>" style="cursor:pointer;" id="<?php echo $id ?>" style="padding:0;"><h4>Delete</h4></a>
