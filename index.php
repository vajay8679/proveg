...
<div class="col-lg-12">
   ...
   <div class="hdr-md-fl" style="margin:0; padding:0;">
      <div id="jssor_1"
         style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1170px; height: 509px; overflow: hidden; visibility: hidden;">
         <!-- Loading Screen -->
         <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div
               style="position:absolute;display:block;background:url('images/loading.html') no-repeat center center;top:0px;left:0px;width:100%;height:100%;">
            </div>
         </div>
         <div data-u="slides"
            style="cursor: default; position: relative; top: 0px; left: 0px; width: 1170px; height: 409px; overflow: hidden;">
            <?php 
               $sliderdata=[];
               if ($conn) {
               ...
               ?>
            <div align="left" data-p="112.50" style="display: inline;">
               <a href="#" title="<?php echo $title; ?>"><img alt="<?php echo $title; ?>"
                  data-u="image" src="admin/<?php echo $img;?>" /></a>
               <a href="#" title="<?php echo $title; ?>"><img alt="<?php echo $title; ?>"
                  data-u="image" src="admin/<?php echo $img;?>" /></a>
               <div data-u="thumb" style="float:left;">
                  <img class="i" src="admin/<?php echo $img;?>" />
                  <div class="t"><?php echo $title; ?></div>
                  <div class="c"><?php echo $description; ?></div>
               </div>
            </div>
            <?php
               }
         ...
         <div data-u="thumbnavigator" class="jssort11"
            style="position:absolute; right:0px; float:left; top:0; font-family:Arial, Helvetica, sans-serif;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none;width:1170px;height:0px; background-color:; margin-top:100px;"
            data-autocenter="2">
         ...
         <div class="column">
            ...
            if ($conn) {
            	$sql = "SELECT * FROM product_cat 
                        WHERE parent_id='0' 
                        AND (id IN (SELECT parent_id FROM product_cat) OR id IN (SELECT oid FROM products)) 
                        ORDER BY `title` ASC 
                        LIMIT 6;";
            ...
            foreach($productdata as $product){
               ...
               $slug = $product['slug'];
            ?>
           <div class="col-md-4" style="margin-bottom: 20px; margin-right: 30px; margin-left: 15px;">
                <div class="shadow" style="margin-bottom: 20px; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);">
                    <div class="space-between-div" style="padding: 20px;">
                        <a class="oneline" href="productdetailpage.php?proid=<?php echo $id; ?>">
                            <img fetchpriority="high" decoding="async" class="homepage_img marg shadow" title="<?php echo $title; ?>" src="admin/upload/product/images/thumb/<?php echo $img;?>" width="500" height="218" />
                            <h1 class="text-center text-ellipsis" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo $title; ?></h1>
                        </a>
                    </div>
                </div>
            </div>
...
<div style="text-align: center;">
    <h1 class="Clients-Reviews animate fadeInUp">Clients Reviews</h1>
</div>
<div class="container">
<div class="items client">
   <?php 
      $testimonialdata=[];
      if ($conn) {
          $sql = "SELECT * FROM testimonial ORDER BY id"; // Fetch data ordered by ID
          $testimonialdata =  $conn->query($sql);  
      }
   ...
   <div class="card">
      <div class="card-body">
         ...
         <div class="row m-2">
            <div class="col-sm-2">
               <img class="profile-pic" src="admin/<?php echo $img; ?>">
            </div>
            <div class="col-sm-10">
               <div class="profile">
                  <h4 class="cust-name mb-2"><?php echo $title; ?></h4>
                  <br>
                  <h6><?php echo $name; ?></h6>
               </div>
            </div>
...
<div style="text-align: center;">
     <h1 class="video-test animate fadeInUp">Video Testimonial</h1>
</div>
<div class="container">
    <div class="items client">
        <?php
        $urldata = [];
        if ($conn) {
            $sql = "SELECT * FROM urltable ORDER BY id"; // Fetch data ordered by ID
            $urldata = $conn->query($sql);
        }
