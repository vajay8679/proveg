...
<body data-rsssl=1 class="page-template-default page page-id-22 wp-embed-responsive custom-font-enabled single-author" ondragstart='return false' onselectstart='return false' class='topc' unselectable='on' >    
...
<div class="container">
<div class="row">
<div class="hedr text-center">
    <img fetchpriority="high" decoding="async" class="img-responsive homepage_img" src="proveg/wp-content/themes/ecotheme/images/enquiry-header.jpg" width="1700" height="208" style="display: block; margin: 0 auto;">
</div>
...
<center>
Please enter the details below and submit:</center>
</h5>
...
<select  class="hlpfrm_100" id="countrylist" name="countrylist">
  ...
  <option value="Canton and Enderbury Islands">Canton
    and Enderbury Islands</option>
  ...
  <option value="Dominican Republic">Dominican
    Republic</option>
  <option value="Dronning Maud Land">Dronning Maud
    Land</option>
  ...
  <option value="St. Kitts Nevis Anguilla">St. Kitts
    Nevis Anguilla</option>
  ...
  <option value="Syran Arab Republic">Syran Arab
    Republic</option>
  ...
  <option value="United States Pacific Islands">United
    States Pacific Islands</option>
  ...
  <option value="Virgin Islands, Unites States">Virgin
    Islands, Unites States</option>
  <option value="Wake Island">Wake Island</option>
  <option value="Wallis and Futuma Islands">Wallis
    and Futuma Islands</option>
